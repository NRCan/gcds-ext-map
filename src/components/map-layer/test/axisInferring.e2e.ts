...
test.describe('Axis Inferring Test', () => {
  let page;
  let context;
  test.beforeAll(async () => {
    ...
    await page.goto('/test/map-layer/axisInferring.html', { waitUntil: 'networkidle' });
  });
  ...
  /**
   *
   * The point of "axisInferring.e2e.ts" is to validate that the extent's cs
