...
<ul className="resources-list">
  ...
  <li>
    <gcds-link size="regular" href="https://github.com/cds-snc/gcds-components/tree/develop/packages/web/src/components/gcds-ext-map" target="_blank">Github</gcds-link>
  </li>
  <li>
