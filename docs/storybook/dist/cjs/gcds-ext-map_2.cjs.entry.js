...
var locale = require('./locale-_4nEyxeO.js');
var MapTileLayer = require('./MapTileLayer-D4vp8bR4.js');
...
const GcdsExtMap = class {
    ...
    async _ensureControlsLoaded() {
        ...
        try {
            ...
            await Promise.resolve().then(function () { return require('./AttributionButton-DgbgLHy4.js'); });
            // Load ContextMenu handler to register init hooks
            await Promise.resolve().then(function () { return require('./index-CW_WOSnc.js'); }).then(function (n) { return n.ContextMenu$1; });
            await Promise.resolve().then(function () { return require('./index-CW_WOSnc.js'); }).then(function (n) { return n.AnnounceMovement$1; });
            await Promise.resolve().then(function () { return require('./index-CW_WOSnc.js'); }).then(function (n) { return n.keyboard; });
            // Load FeatureIndex handler to register init hooks for keyboard navigation
            await Promise.resolve().then(function () { return require('./index-CW_WOSnc.js'); }).then(function (n) { return n.FeatureIndex$1; });
