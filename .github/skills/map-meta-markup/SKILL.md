...
| Name          | Description                                          	  |
|--------------	|--------------------------------------------------------	|
| projection    | Set the [projection](../gcds-ext-map/#projection) for the document |
...
| `name`          | `content` value                                          	  |
|--------------	|--------------------------------------------------------	|
| projection    | A case-sensitive [projection name](../gcds-ext-map#projection), or a [custom projection name](../../api/gcds-ext-map-api#definecustomprojectionoptions) |
