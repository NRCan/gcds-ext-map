...
Map media queries can include map properties including: [projection](../../api/gcds-ext-map-api#projection), [zoom](../../api/gcds-ext-map-api#zoom), 
and [extent](../../api/gcds-ext-map-api#extent).
...
```html
<gcds-ext-map projection="OSMTILE" zoom="10" lon="-75.7" lat="45.4" controls>
