...
```html
<gcds-ext-map projection="OSMTILE" lat="10" lon="0" zoom="1">
...
server.  If the projection value is a case-insensitive match of the `<gcds-ext-map>`
...
Author-defined values of `units` are possible, using the [Custom projections API](../../api/gcds-ext-map-api/#definecustomprojectionoptions)
...
```html
<gcds-ext-map projection="OSMTILE" zoom="2" lat="53.331" lon="-91.667" controls>
...
```html
<gcds-ext-map projection="OSMTILE" zoom="4" lat="53.331" lon="-91.667" controls>
